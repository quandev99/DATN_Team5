...
const VariantUpdate = () => {
  return (
    <div>
      <h1 className="font-bold text-3xl text-center">Cập nhật biến thể</h1>
      ...
      <div className="mt-10">
        <form action="" className="flex flex-col gap-y-5">
          ...
          <button className="border w-52 h-10 rounded-lg bg-green-400 font-bold">Cập nhật biến thể</button>
