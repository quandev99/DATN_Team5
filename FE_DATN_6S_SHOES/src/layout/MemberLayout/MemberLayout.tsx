...
const AdminLayout = () => {
  ...
  return (
    <div className="flex w-screen">
      <nav
        className={`fixed top-0 z-50 w-full border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 ${
          hasScrolled ? "shadow transition-all " : " transition-all py-1"
        }`}
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <Link to="/" className="flex ml-2 md:mr-24">
                <img
                  className="h-14 mr-3"
                  src="https://res.cloudinary.com/djlylbhrb/image/upload/v1697540176/h9ruhsfbuzwuq137kzwo.png"
                  alt=""
                />
                ...
                <div>
                  ...
                  >
                    ...
                    <img
                      ...
                      src={userDetail?.user_avatar?.url}
                      alt="user photo"
                    />
                  </button>
                </div>
      ...
      <div className="p-6 sm:ml-64 w-screen ">
        <div
          className={`p-4 bg-white    rounded-lg dark:border-gray-700 mt-14`}
        >
          <Outlet />
        </div>
      </div>
